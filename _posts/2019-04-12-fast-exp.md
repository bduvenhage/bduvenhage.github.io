...
The exponential function and specifically the natural exponential function is used often in machine learning, simulated annealing and other types of solutions. Part of the reason why the natural exponential is so useful is that it is quite unique in that it is its own derivative. Put differently, the slope of the function is equal to its height! A fast non-tabel-lookup approximation of the natural exponential function would be very useful to accelerate many calculations in the sciences.
